...
3. Click on down-arrow next to "New Project" the **labs** Project. THen select "New Project from Git Repo"

![](../Images/rstudio-cloud-project.png)

4. Enter the URL of the Git repository (<https://github.com/cdmuir/biol297-spring2020>), then click OK: 
...
----------|-------------
 ...
 Number of televersions per person |
...
For the same 10 animals, they also measured the oxygen consumption in non-feeding
dives. With the 10 animals in the same order as before, here are those data:
